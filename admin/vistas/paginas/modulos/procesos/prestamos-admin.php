...
if (isset($_GET['ex'])) {
    ...
    swal({
        ...
        if(result.value){
            window.location = "' . $ruta . 'admin/prestamos";
        }
    });
</script>';
}
    ...
    <section class="content">
        ...
        <div class="card card-info card-outline">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-grip-horizontal text-info"></i>
                    Lista de Prestamos
                </h3>
            ...
            <div class="card-body">
                <table class="table table-striped table-bordered dt-responsive tablaPrestamosPend" width="100%">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Usuario</th>
